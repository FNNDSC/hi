...
LABEL org.opencontainers.image.authors="FNNDSC <dev@babyMRI.org>" \
      org.opencontainers.image.title="Hello world ChRIS Plugin" \
      org.opencontainers.image.description="A ChRIS plugin to greet the world! :)"

ARG SRCDIR=/usr/local/src/hi
WORKDIR ${SRCDIR}
